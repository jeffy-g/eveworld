...
l.add(WorldConfig,"resetCamera"),l.add(WorldConfig,"updateRegionColors");const g=l.addFolder("World Config#1").close();{
...
o.depthFunc=+e,o.needsUpdate=!0}))}));const m=l.addFolder("Region Visibility").close();{
const e=EVEWorld.getRegionObjects(),o=Object.keys(e).sort(),a=WorldConfig.regionVisibility
;c=m.add(a,"Region name").onChange((function(e){forEachRegioins((o=>{n(o,e)}))})),
m.add(a,"Text scale").min(0).max(10).step(.01).onChange((function(e){forEachRegioins((o=>{const n=t(o);n&&(n.scale2d=e)
}))}));const i=/\w-\w\d{5}/,d=m.addFolder("wormhole region").close(),r=m.addFolder("universe region").close(),s=[]
...
n(a,o))}));o&&s.push(c)}}const C=l.addFolder("Effect Sound").close();{const o=AppEffects.getDefaultTagList()
...
const h=l.addFolder("Render config").close()
...
$queryAll(".controller.boolean,.controller.number,.controller.function").forEach((e=>{let o="";switch(e.textContent){
case"helperMode":o="Switch browse mode and helper mode.";break;case"showAxes":o="Axes line length: 50LY";break
;case"showGrid":o="Grid distance: 4LY";break;case"resetCamera":
o="Return to default camera position then look at world center";break;case"updateRegionColors":
o="Update system fill color randomly";break;case"dcad":o="(d)efault (C)amera (A)nimate (D)uration"}o&&(e.title=o)}))}
}(ConfigUI||(ConfigUI={}));export default ConfigUI;