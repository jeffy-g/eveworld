...
p.add(e,"rotateRadiusAdjust",-300,300,.1),p.add(e,"dcad",1,20,.1)}p.open();const u=l.addFolder("Material config")
;u.add(WorldConfig,"Apply texture").onChange((e=>{const o=e?EVEWorld.getSystemTexture():null
;forEachRegioinsMaterial((e=>{e.map=o,e.needsUpdate=!0}))})),u.add(WorldConfig,"transparent").onChange((e=>{
forEachRegioinsMaterial((o=>{o.transparent=e,o.needsUpdate=!0}))
...
o.depthFunc=+e,o.needsUpdate=!0}))}));const m=l.addFolder("Region Visibility");{
...
}))}));const i=/\w-\w\d{5}/,d=m.addFolder("wormhole region"),r=m.addFolder("universe region"),s=[]
