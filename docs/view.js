...
;const r=new THREE.CSS2DObject(s,a.scale);return r.position.set(t,n,o),r};const t={minimumFractionDigits:3,
...
}const r=new THREE.AxesHelper(UniverseUnit.ly(50));return r.visible=WorldConfig.showAxes,
e.add((new THREE.Object3D).add(r,s,n,a)),o=!0,{axes:r,gridHelper:s,cameraHelper:n,objectiveCamera:a,
...
;const r=new THREE.Raycaster;r.params.Points.threshold=UniverseUnit.LY*WorldConfig["Ray threshold(LY)"]
;const i=new THREE.WebGLRenderer({antialias:!0,logarithmicDepthBuffer:!0,preserveDrawingBuffer:!0,
powerPreference:"high-performance"});i.domElement.classList.add("eve-world"),i.setClearColor(0,1),
i.setPixelRatio(WorldConfig.PixelRatio),i.setSize(e,t);const l=new THREE.CSS2DRenderer;l.setSize(e,t),
l.domElement.classList.add("css2d-view")
;const d=new THREE.OrbitControls(s,i.domElement),c=new THREE.OrbitControls(s,l.domElement)
;c.keyPanSpeed=d.keyPanSpeed=.8,d.enableDamping=!0,d.dampingFactor=.3,c.enableDamping=!0,c.dampingFactor=.3
;const p=a(o,s);return window.ThreeComponents=Object.assign(p,{stats:n,orbit:d,orbit2:c,scene:o,camera:s,raycaster:r,
webGLRenderer:i,labelRenderer:l})}e.createHelpers=a,e.getTHREERelated=function(){
