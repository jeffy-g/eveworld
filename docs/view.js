...
s.textContent=e,a.rgba&&(s.style.color=a.rgba),a.className&&a.className.split(/,| /g).forEach(e=>e&&s.classList.add(e))
...
;function a(e=window.innerWidth,t=window.innerHeight){
...
r.setClearColor(0,1),r.setPixelRatio(WorldConfig.PixelRatio),r.setSize(e,t),r.gammaFactor=WorldConfig.gammaFactor
;const i=new THREE.CSS2DRenderer;i.setSize(e,t),i.domElement.classList.add("css2d-view")
;const d=new THREE.OrbitControls(a,r.domElement),l=new THREE.OrbitControls(a,i.domElement)
;return l.keyPanSpeed=d.keyPanSpeed=.8,d.enableDamping=!0,d.dampingFactor=.3,l.enableDamping=!0,l.dampingFactor=.3,
window.ThreeComponents={stats:n,orbit:d,orbit2:l,scene:o,camera:a,raycaster:s,webGLRenderer:r,labelRenderer:i}}
e.createHelpers=function(){if(!o){console.log("View::createHelpers")
;const{scene:e,camera:t}="undefined"==typeof ThreeComponents?a():ThreeComponents,n=new THREE.Object3D;e.add(n);{
...
return"undefined"==typeof ThreeComponents?a():ThreeComponents},e.createTHREERelated=a}(View||(View={}))
;export default View;